...
// ─── Section: TVC Video Showcase (HD 1080p Ultra-Sharp Preview & Direct Play) ──
  ...
  return (
    <section id="featured-videos" className="py-16 sm:py-24 bg-[#FAFAF8] relative scroll-mt-28 border-b border-slate-200/60 overflow-hidden select-none">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
        ...
        {/* Minimalist HD Video Scroll Container */}
        <div
          ref={scrollRef}
          ...
          {videoIds.map((id, idx) => (
            ...
            >
              <FadeUp delay={idx * 100}>
                <div className="relative aspect-video w-full rounded-2xl sm:rounded-3xl overflow-hidden bg-slate-950 shadow-md border border-slate-200/80 hover:shadow-2xl transition-all duration-500 group">
                  {activeVideoId === id ? (
                    <iframe
                    ...
                    >
                      {/* Ultra-Sharp 1280x720 HD MaxRes Thumbnail */}
                      <img
                        src={`https://img.youtube.com/vi/${id}/maxresdefault.jpg`}
                        onError={(e) => {
                          // Fallback to hqdefault if maxresdefault isn't generated by YouTube yet
                      ...
                      {/* Clean Minimalist Play Icon Overlay */}
                      <div className="absolute inset-0 flex items-center justify-center">
                        <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-white/90 backdrop-blur-md text-slate-900 flex items-center justify-center shadow-xl group-hover/thumb:scale-110 group-hover/thumb:bg-blue-600 group-hover/thumb:text-white transition-all duration-300">
